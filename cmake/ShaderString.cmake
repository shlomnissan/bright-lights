...
foreach(SHADER IN LISTS SHADERS)
    ...
    set(HEADER_FILE ${DIRECTORY}/../${FILENAME_NO_EXT}_${EXTENSION}.h)

    message("🎨 Writing shader ${FILENAME_NO_EXT}_${EXTENSION}.h")

    file(READ ${SHADER} CONTENTS)
    file(WRITE ${HEADER_FILE} "static const char* _SHADER_${FILENAME_NO_EXT}_${EXTENSION} = R\"(")
